# Environment Setup for HANDS ON :
        PWD as of now : 
            /Documents/y_claude_code_folder/y_spark_related/y_env_for_struct_stream
            > cd ~/Documents/y_claude_code_folder/y_spark_related/y_env_for_struct_stream

        1) Create VENV to has libraries installed :
                > python3 -m venv y_env_for_struct_stream

        2) Activate the venv for installing required libs :
                > source ./y_env_for_struct_stream/bin/activate
